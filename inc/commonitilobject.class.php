...
abstract class CommonITILObject extends CommonDBTM
{
    ...
    **/
     ...
     * @param bool $purecontent true : nothing change / false : convert to HTML display
     *
    ...
    **/
     ...
     * @param $options   array    options for default values ($options of showForm)
     *
     * @return int Random part of inputs ids
    **/
    ...
    **/
    public function showActorsPartForm($ID, array $options)
    {
        ...
        } elseif (!$is_hidden['_users_id_requester']) {
        ...
        } elseif (!$is_hidden['_groups_id_requester']) {
        ...
        } elseif (!$is_hidden['_users_id_observer']) {
        ...
        } elseif (!$is_hidden['_groups_id_observer']) {
        ...
        } elseif (!$is_hidden['_users_id_assign']) {
        ...
        } elseif (!$is_hidden['_groups_id_assign']) {
        ...
        } elseif (!$is_hidden['_suppliers_id_assign']) {
    ...
    **/
    public static function getSplittedSubmitButtonHtml($items_id, $action = "add")
    {
     ...
     * @since 9.4.0
     *
     * @param int $rand random value used by JavaScript function names
     *
     * @return void
     */
     ...
     * @since 9.4.0
     *
     * @param int $rand random value used by div
     *
     * @return void
     */
    public function showTimeline($rand)
    {
        ...
        foreach ($timeline as $item) {
            ...
            if (
                ($item['type'] == "Solution") && $item_i['status'] != CommonITILValidation::REFUSED
