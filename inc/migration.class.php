...
class Migration
{
    ...
    **/
    public function renameTable($oldtable, $newtable)
    {
        ...
        if (!$DB->tableExists("$newtable") && $DB->tableExists("$oldtable")) {
            ...
            if (
                Toolbox::startsWith($oldtable, 'glpi_plugin_')
    ...
    **/
     ...
     *
     * @return int id of the last item inserted by mysql
    **/
    ...
    **/
    public function createRule(array $rule, array $criteria, array $actions)
    {
        ...
        $rule['comment']     = sprintf(__('Automatically generated by ITSM-NG %s'), $this->version);
        $rule['description'] = '';
