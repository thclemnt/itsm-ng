...
class Auth extends CommonGLPI
{
     ...
     * @param int $link     show links to config page? (default 0)
     ...
     *
     * @return void|int nothing if redirect is true, else Auth system ID
     */
     ...
     * @param int    $tabnum       Unused (default 0)
     * @param int    $withtemplate Unused (default 0)
     *
     * @return bool
     */
     ...
     */
    public static function showAuthOIDCConfig()
    {
        global $DB, $CFG_GLPI;
     ...
     */
    public static function getDefaultLoginAuthSource(): string
    {
        $elements = self::getLoginAuthMethods();
