...
class Toolbox
{
    ...
    **/
     ...
     * @deprecated 9.5.0
    **/
    public static function userErrorHandlerNormal($errno, $errmsg, $filename, $linenum)
    {
     ...
     * @deprecated 9.5.0
    **/
    public static function userErrorHandlerDebug($errno, $errmsg, $filename, $linenum)
    {
    ...
    **/
     ...
     *    0 = OK
     */
    public static function commonCheckForUseGLPI($isInstall = false)
    {
        global $DB;
        ...
        if ($core_requirements->hasMissingMandatoryRequirements()) {
            return 2;
        } elseif ($core_requirements->hasMissingOptionalRequirements()) {
            return 1;
        } else {
            return 0;
        }
     ...
     * @deprecated 9.5.0
    **/
    public static function checkSELinux($fordebug = false)
    {
        Toolbox::deprecated();
    ...
    **/
     ...
     * @deprecated 9.5.0
    **/
    public static function canUseImapPop()
    {
    ...
    **/
    public static function convertImageToTag($content_html, $force_update = false)
    {
    ...
    **/
     ...
     * @since 9.5.0
     */
    public static function savePicture($src, $uniq_prefix = null)
    {
...
HTML;
     ...
     */
    public static function getFgColor(string $color = "", int $offset = 40): string
    {
        $fg_color = "FFFFFF";
        if ($color !== "") {
