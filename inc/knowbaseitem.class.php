...
class KnowbaseItem extends CommonDBVisible implements ExtraVisibilityCriteria
{
    ...
    * @since 0.83
    *
    * @param bool $forceall  force all joins
    *
            ...
            'content' => [
                ...
                self::getTypeName(1) => [
                    ...
                    'inputs' => [
                        ...
                        __('Put this item in the FAQ') => Session::haveRight(
                            self::$rightname,
                            self::PUBLISHFAQ
                        ) ? [
                            'type' => 'checkbox',
                        ...
                        __('Views') => $ID ? [
                            'content' => sprintf(
                                _n('%d view', '%d views', $this->fields["view"]),
                                $this->fields["view"]
                            ),
                        ] : [],
    ...
    **/
     ...
     * @return void
    **/
    public static function showRecentPopular($type)
    {
        global $DB;
