...
class Profile extends CommonDBTM
{
    ...
    public function showFormTrackingHelpdesk()
    {
        ...
        $rights = [
            [
                'rights'     => Profile::getRightsFor('Ticket', 'helpdesk'),
    ...
    public function showFormToolsHelpdesk()
    {
        ...
        $rights = [
            [
                'rights'    => Profile::getRightsFor('KnowbaseItem', 'helpdesk'),
                'label'     => __('FAQ'),
                'field'     => 'knowbase',
            ],
            [
     ...
     * @param $closeform    boolean  close the form (true by default)
     **/
    public function showFormAccess($openform = true, $closeform = true)
    {
        if (!self::canView()) {
            return false;
        }
    ...
    * @since 0.85
   **/
    public function showFormAccessHelpdesk($openform = true, $closeform = true)
    {
        if (!self::canView()) {
            return false;
        }
