...
class Ticket extends CommonITILObject
{
     ...
     * @param int $id the sla/ola id
     * @param int $subtype (SLM::TTR | SLM::TTO)
     ...
     *
     * @param bool $alldata  (false by default)
     *
     * @return array
     **/
     ...
     *
     * @param int $ID               ID of the user who want to display the Helpdesk
     * @param bool $ticket_template  Ticket template for preview : false if not used for preview
     *                                  (false by default)
     *
     * @return bool|void
     **/
     ...
     *
     * @param int $force_template      Itiltemplate_id to used (case of preview for example)
     *                             (default 0)
     * @param int $type                Type of the ticket (default 0)
     * @param int $itilcategories_id   Ticket category (default 0)
     * @param int $entities_id         (default -1)
     *
     * @since 0.84
     * @deprecated 9.5.0
     *
     ...
     * Get tickets count
     *
     * @param bool $foruser  Only for current login user as requester (false by default)
     **/
        ...
        if (isset($field_id_or_search_options['field']) && isset($field_id_or_search_options['datatype'])) {
            ...
            && $field_id_or_search_options['datatype'] === 'date') {
                ...
                return Html::showDateField($name, [
                    ...
                    'display' => false,
                    'showtime' => false,
                    'relative_dates' => $options['relative_dates'] ?? false,
                ] + $options);
            }
        }
