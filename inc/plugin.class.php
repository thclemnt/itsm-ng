...
class Plugin extends CommonDBTM
{
    ...
    **/
     ...
     * Init plugins list.
     *
     * @param bool $load_plugins     Whether to load active/configurable plugins or not.
    ...
    **/
    public function activate($ID)
    {
        ...
        if ($this->getFromDB($ID)) {
            ...
            if (
                !isset($PLUGIN_HOOKS['csrf_compliant'][$this->fields['directory']])
            ...
            if (!function_exists($function) || $function()) {
                ...
                if (
                    isset($PLUGIN_HOOKS['init_session'][$this->fields['directory']])
                ...
                if (
                    isset($PLUGIN_HOOKS['change_profile'][$this->fields['directory']])
    ...
    **/
     ...
     * @deprecated 9.5.0
     *
     * @param int $name System name (Plugin directory)
     *
     * @return void
     */
        ...
        switch ($field) {
            case 'id':
                ...
                if ($state === self::ACTIVATED) {
                    ...
                    if (
                        !isset($PLUGIN_HOOKS['csrf_compliant'][$directory])
