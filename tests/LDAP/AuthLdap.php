...
class AuthLDAP extends DbTestCase
{
    ...
    private function assertLdapConnection($connection)
    {
        if (class_exists(Connection::class)) {
            $this->object($connection)->isInstanceOf(Connection::class);
            return;
        }
    ...
    public function testTestLDAPConnection()
    {
        ...
        $this->assertLdapConnection($ldap->connect());
    }
    ...
    public function testGetGroupCNByDn()
    {
        ...
        $this->assertLdapConnection($connection);
    ...
    public function testLdapAuth()
    {
        ...
        $this->assertLdapConnection($auth->ldap_connection);
